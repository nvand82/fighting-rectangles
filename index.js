...
//   draw(){
//     //draw constant
//     c.drawImage(playerImage, 0, 0 , 32, 64, this.position.x, this.position.y, 32, 64);
//     c.fillStyle = "white"
...
//     this.velocity.y = 0 
//     }
//     else if(this.position.y + this.height < canvas.height/2 - 2 && this.position.y + this.height > 288 - 32 && this.position.x >= 288-32 &&
//       this.position.x <= 512+64){
//         this.velocity.y = 0
//     }
//     else{
